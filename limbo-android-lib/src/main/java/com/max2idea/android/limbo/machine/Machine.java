...
public class Machine extends Observable {
    ...
    /**
     * SSD化フラグの取得
     * @return 1: SSD有効, 0: 通常HDD
     */
    public int getEnableSsd() {
        return enableSsd;
    }

    /**
     * SSD化フラグの設定
     * @param enableSsd 1: SSD有効, 0: 通常HDD
     */
    public void setEnableSsd(int enableSsd) {
        if (this.enableSsd != enableSsd) {
            this.enableSsd = enableSsd;
            setChanged();
            notifyChanged(MachineProperty.ENABLE_SSD, enableSsd);
        }
    }
