...
***/
    ...
    public void setOrientationBis(int w, int h, boolean resizable, String hint)
    {
        ...
        if (orientation != -1 && mSingleton != null) {
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        boolean skip = false;
        int requestedOrientation = (SDLActivity.mSingleton != null) ? SDLActivity.mSingleton.getRequestedOrientation() : ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED;
